 ...
 * @author CBS
 */
public class Justification extends javax.swing.JFrame {

    /**
     * Creates new form Justification
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nom", "Prénom", "Classe", "Cours", "Date", "Motif"
            }
        ));
        ...
        jLabel1.setText("Justification des absences");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Justification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Justification().setVisible(true);
            }
        });
    }
